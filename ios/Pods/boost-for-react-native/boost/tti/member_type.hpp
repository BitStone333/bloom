...
#if !defined(BOOST_TTI_TYPE_HPP)
#define BOOST_TTI_TYPE_HPP
...
*/
#define BOOST_TTI_TRAIT_TYPE(trait,name) \
    BOOST_TTI_DETAIL_TRAIT_HAS_TYPE_TYPE(trait,name) \
    BOOST_TTI_DETAIL_TRAIT_TYPE(trait,name) \
    ...
    struct trait : \
      boost::mpl::eval_if \
        ...
        BOOST_PP_CAT(trait,_detail_type)<BOOST_TTI_TP_T>, \
...
/**
    ...
    generates a metafunction called "type_name" where 'name' is the macro parameter.
...
*/
#define BOOST_TTI_TYPE(name) \
  BOOST_TTI_TRAIT_TYPE \
  ( \
  BOOST_TTI_TYPE_GEN(name), \
  name \
  ) \
/**/
...
namespace boost
  ...
  namespace tti
    ...
    /// A metafunction which checks whether the member 'type' returned from invoking the macro metafunction generated by BOOST_TTI_TYPE ( BOOST_TTI_TRAIT_TYPE ) is a valid type.
    /**
        ...
        The metafunction types and return:
          ...
          BOOST_TTI_TP_T           = returned inner 'type' from invoking the macro metafunction generated by BOOST_TTI_TYPE ( BOOST_TTI_TRAIT_TYPE ).
          BOOST_TTI_TP_MARKER_TYPE = (optional) a type to use as the marker type.
                            defaults to the internal boost::tti::detail::notype.
    ...
    */
    ...
    /// A metafunction which checks whether the invoked macro metafunction generated by BOOST_TTI_TYPE ( BOOST_TTI_TRAIT_TYPE ) hold a valid type.
    /**

        template<class TTI_METAFUNCTION>
        struct valid_metafunction
          {
          static const value = unspecified;
          typedef mpl::bool_<true-or-false> type;
          };
        ...
        The metafunction types and return:
          ...
          TTI_METAFUNCTION = The invoked macro metafunction generated by BOOST_TTI_TYPE ( BOOST_TTI_TRAIT_TYPE ).
