...
#if !defined(BOOST_TTI_HAS_STATIC_FUNCTION_HPP)
#define BOOST_TTI_HAS_STATIC_FUNCTION_HPP
...
#include <boost/tti/gen/has_static_function_gen.hpp>
...
*/
#define BOOST_TTI_TRAIT_HAS_STATIC_FUNCTION(trait,name) \
  BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_FUNCTION(trait,name) \
...
/**
    ...
    generates a metafunction called "has_static_function_name" where 'name' is the macro parameter.
...
*/
#define BOOST_TTI_HAS_STATIC_FUNCTION(name) \
  BOOST_TTI_TRAIT_HAS_STATIC_FUNCTION \
  ( \
  BOOST_TTI_HAS_STATIC_FUNCTION_GEN(name), \
  name \
  ) \
/**/

#endif // BOOST_TTI_HAS_STATIC_FUNCTION_HPP
