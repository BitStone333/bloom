...
#if !defined(BOOST_TTI_HAS_STATIC_DATA_HPP)
#define BOOST_TTI_HAS_STATIC_DATA_HPP

#include <boost/config.hpp>
#include <boost/preprocessor/cat.hpp>
#include <boost/tti/gen/has_static_data_gen.hpp>
...
*/
#define BOOST_TTI_TRAIT_HAS_STATIC_DATA(trait,name) \
  BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_DATA(trait,name) \
...
/**
    ...
    generates a metafunction called "has_static_data_name" where 'name' is the macro parameter.
...
*/
#define BOOST_TTI_HAS_STATIC_DATA(name) \
  BOOST_TTI_TRAIT_HAS_STATIC_DATA \
  ( \
  BOOST_TTI_HAS_STATIC_DATA_GEN(name), \
  name \
  ) \
/**/

#endif // BOOST_TTI_HAS_STATIC_DATA_HPP
