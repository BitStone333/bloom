...
#define BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_DATA_OP(trait,name) \
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_DATA(trait,name) \
  BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_DATA_OP(trait,name) \
  template<class BOOST_TTI_DETAIL_TP_T,class BOOST_TTI_DETAIL_TP_TYPE> \
