...
#define BOOST_TTI_DETAIL_TRAIT_IMPL_HAS_STATIC_FUNCTION(trait,name) \
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_FUNCTION_OP(trait,name) \
  BOOST_TTI_DETAIL_TRAIT_IMPL_HAS_STATIC_FUNCTION(trait,name) \
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_FUNCTION(trait,name) \
  BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_FUNCTION_OP(trait,name) \
  template<class BOOST_TTI_DETAIL_TP_T,class BOOST_TTI_DETAIL_TP_R,class BOOST_TTI_DETAIL_TP_FS,class BOOST_TTI_DETAIL_TP_TAG> \
