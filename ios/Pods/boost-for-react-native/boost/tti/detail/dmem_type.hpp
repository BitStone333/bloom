...
#define BOOST_TTI_DETAIL_TRAIT_HAS_TYPE_TYPE_OP(trait,name) \
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_TYPE_TYPE(trait,name) \
  BOOST_TTI_DETAIL_TRAIT_HAS_TYPE_TYPE_OP(trait,name) \
  template<class BOOST_TTI_DETAIL_TP_T> \
...
#define BOOST_TTI_DETAIL_TRAIT_TYPE(trait,name) \
  template<class BOOST_TTI_DETAIL_TP_T> \
