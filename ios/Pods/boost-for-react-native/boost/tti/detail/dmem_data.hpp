...
#include <boost/function_types/is_object_pointer.hpp>
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_DATA_OP(trait,name) \
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_DATA_OP(trait,name) \
  BOOST_TTI_DETAIL_TRAIT_HAS_TYPES_FUNCTION(trait,name) \
  template<class BOOST_TTI_DETAIL_TP_T,class BOOST_TTI_DETAIL_TP_C> \
  struct BOOST_PP_CAT(trait,_detail_hmd_op) : \
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_DATA_INVOKE_ENCLOSING_CLASS(trait) \
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_DATA_INVOKE_PT_MEMBER(trait) \
  template<class BOOST_TTI_DETAIL_TP_ET,class BOOST_TTI_DETAIL_TP_TYPE> \
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_DATA_WITH_ENCLOSING_CLASS(trait) \
  BOOST_TTI_DETAIL_TRAIT_HAS_DATA_INVOKE_ENCLOSING_CLASS(trait) \
  template<class BOOST_TTI_DETAIL_TP_ET,class BOOST_TTI_DETAIL_TP_TYPE> \
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_DATA(trait,name) \
  BOOST_TTI_DETAIL_TRAIT_HAS_DATA_OP(trait,name) \
  BOOST_TTI_DETAIL_TRAIT_HAS_DATA_WITH_ENCLOSING_CLASS(trait) \
  BOOST_TTI_DETAIL_TRAIT_HAS_DATA_INVOKE_PT_MEMBER(trait) \
  template<class BOOST_TTI_DETAIL_TP_ET,class BOOST_TTI_DETAIL_TP_TYPE> \
  ...
  namespace tti
    ...
    namespace detail
      ...
      struct dmem_check_ptmd :
        ...
        {
        BOOST_MPL_ASSERT((boost::function_types::is_object_pointer<BOOST_TTI_DETAIL_TP_T>));
        };
