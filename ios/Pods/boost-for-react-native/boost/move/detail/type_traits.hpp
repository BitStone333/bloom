...
//           is_pointer
//////////////////////////////////////
template <class T>         struct is_pointer_cv         {  static const bool value = false; };
template <class T, class U>struct is_pointer_cv<T U::*> {  static const bool value = true; };

template <class T>
struct is_pointer
    : is_pointer_cv<typename remove_cv<T>::type>
{};
...
//////////////////////////////////////
template <class T>
struct is_function_pointer_cv
{
   static const bool value = false;
};

template <class T, class C>
struct is_function_pointer_cv<T C::*>
   : is_function<T>
{};

template <class T>
struct is_function_pointer
    : is_function_pointer_cv<typename remove_cv<T>::type>
{};
...
typedef int (alignment_dummy::*ptr);
typedef int (alignment_dummy::*function_ptr)();
