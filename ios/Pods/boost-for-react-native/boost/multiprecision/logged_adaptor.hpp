...
NON_OP3(multiply, "*");
NON_OP3(divide, "/");
NON_OP3(multiply_add, "fused-multiply-add");
NON_OP3(multiply_subtract, "fused-multiply-subtract");
NON_OP4(multiply_add, "fused-multiply-add");
NON_OP4(multiply_subtract, "fused-multiply-subtract");

NON_OP1(increment, "increment");
NON_OP1(decrement, "decrement");
...
NON_OP2(bitwise_xor, "^=");
NON_OP3(bitwise_xor, "^");
NON_OP4(qr, "quotient-and-remainder");
NON_OP2(complement, "~");
