...
//!   - boost::intrusive::slist / boost::intrusive::slist_base_hook / boost::intrusive::slist_hook
//!   - boost::intrusive::list / boost::intrusive::list_base_hook / boost::intrusive::list_hook
//!   - boost::intrusive::bstree / boost::intrusive::bs_set / boost::intrusive::bs_multiset /
//!      boost::intrusive::bs_set_base_hook / boost::intrusive::bs_set_hook
//!   - boost::intrusive::rbtree / boost::intrusive::set / boost::intrusive::multiset /
//!      boost::intrusive::set_base_hook / boost::intrusive::set_hook
//!   - boost::intrusive::avltree / boost::intrusive::avl_set / boost::intrusive::avl_multiset /
//!      boost::intrusive::avl_set_base_hook / boost::intrusive::avl_set_hook
...
//!      boost::intrusive::unordered_set_base_hook / boost::intrusive::unordered_set_hook /
//!   - boost::intrusive::any_base_hook / boost::intrusive::any_hook
//!
...
//!   - boost::intrusive::value_traits / boost::intrusive::hook / boost::intrusive::function_hook / boost::intrusive::base_hook
