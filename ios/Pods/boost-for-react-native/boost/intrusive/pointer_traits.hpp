...
BOOST_INTRUSIVE_HAS_STATIC_FUNC_SIGNATURE(has_function_callable_with_pointer_to, pointer_to)
BOOST_INTRUSIVE_HAS_STATIC_FUNC_SIGNATURE(has_function_callable_with_dynamic_cast_from, dynamic_cast_from)
BOOST_INTRUSIVE_HAS_STATIC_FUNC_SIGNATURE(has_function_callable_with_static_cast_from, static_cast_from)
BOOST_INTRUSIVE_HAS_STATIC_FUNC_SIGNATURE(has_function_callable_with_const_cast_from, const_cast_from)
#else
BOOST_INTRUSIVE_HAS_FUNC_CALLED_IGNORE_SIGNATURE(has_function_callable_with_pointer_to, pointer_to)
BOOST_INTRUSIVE_HAS_FUNC_CALLED_IGNORE_SIGNATURE(has_function_callable_with_dynamic_cast_from, dynamic_cast_from)
BOOST_INTRUSIVE_HAS_FUNC_CALLED_IGNORE_SIGNATURE(has_function_callable_with_static_cast_from, static_cast_from)
BOOST_INTRUSIVE_HAS_FUNC_CALLED_IGNORE_SIGNATURE(has_function_callable_with_const_cast_from, const_cast_from)
#endif
...
struct pointer_traits
{
   ...
   static pointer pointer_to(reference r)
   {
      ...
      const bool value = boost::intrusive::detail::
         has_function_callable_with_pointer_to
   ...
   static pointer static_cast_from(const UPtr &uptr)
   {
      ...
      const bool value = boost::intrusive::detail::
         has_function_callable_with_static_cast_from
   ...
   static pointer const_cast_from(const UPtr &uptr)
   {
      typedef const UPtr &RefArg;
      const bool value = boost::intrusive::detail::
         has_function_callable_with_const_cast_from
            <pointer, pointer(*)(RefArg)>::value
         || boost::intrusive::detail::
               has_function_callable_with_const_cast_from
                  <pointer, pointer(*)(UPtr)>::value;
   ...
   static pointer dynamic_cast_from(const UPtr &uptr)
   {
      typedef const UPtr &RefArg;
      const bool value = boost::intrusive::detail::
         has_function_callable_with_dynamic_cast_from
            <pointer, pointer(*)(RefArg)>::value
         || boost::intrusive::detail::
               has_function_callable_with_dynamic_cast_from
                  <pointer, pointer(*)(UPtr)>::value;
