...
//BOOST_INTRUSIVE_OPTION_TYPE (hook, Parent BOOST_INTRUSIVE_COMMA class MemberHook BOOST_INTRUSIVE_COMMA MemberHook Parent::* PtrToMember , mhtraits BOOST_INTRUSIVE_LESS Parent BOOST_INTRUSIVE_COMMA MemberHook BOOST_INTRUSIVE_COMMA PtrToMember BOOST_INTRUSIVE_MORE , proto_value_traits)
...
//      , MemberHook::hooktags::link_mode> value_traits;
   typedef mhtraits <Parent, MemberHook, PtrToMember> value_traits;
   template<class Base>
   struct pack : Base
   {
      typedef value_traits proto_value_traits;
   };
/// @endcond
};
