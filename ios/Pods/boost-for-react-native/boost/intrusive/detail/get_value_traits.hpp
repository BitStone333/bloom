...
{
   typedef typename MemberHook::value_traits type;
};
...
template <class T>
struct internal_value_traits
{
   template <class U> static yes_type test(...);
   template <class U> static no_type test(typename U::value_traits* = 0);
...
template<class SupposedValueTraits, bool = internal_value_traits<SupposedValueTraits>::value>
struct supposed_value_traits;
...
struct supposed_base_value_traits<SupposedValueTraits, T, false>
   : supposed_value_traits<SupposedValueTraits>
{};

//...It's a member hook
template<class MemberHook>
struct supposed_value_traits<MemberHook, true>
   : get_value_traits<MemberHook>
{};

//...Not a member hook
template<class SupposedValueTraits>
struct supposed_value_traits<SupposedValueTraits, false>
