...
#define BOOST_INTRUSIVE_HAS_STATIC_FUNC_SIGNATURE(TRAITS_NAME, FUNC_NAME) \
...
#define BOOST_INTRUSIVE_HAS_FUNC_CALLED(TRAITS_NAME, FUNC_NAME) \
...
#define BOOST_INTRUSIVE_HAS_FUNC_CALLED_IGNORE_SIGNATURE(TRAITS_NAME, FUNC_NAME) \
BOOST_INTRUSIVE_HAS_FUNC_CALLED(TRAITS_NAME##_ignore_signature, FUNC_NAME) \
\
