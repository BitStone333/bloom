...
namespace boost {
  ...
  namespace detail {
    ...
    BOOST_TTI_HAS_FUNCTION(finish_edge)
    ...
    void call_finish_edge(Vis& vis, E e, const G& g) { // Only call if method exists
     ...
     (defined(__INTEL_COMPILER) && (__INTEL_COMPILER >= 1200)))
      do_call_finish_edge<
        has_function_finish_edge<Vis, void,
          boost::mpl::vector<E, const G&> >::value>::call_finish_edge(vis, e, g);
#else
      do_call_finish_edge<has_function_finish_edge<Vis, void>::value>::call_finish_edge(vis, e, g);
#endif
    }
