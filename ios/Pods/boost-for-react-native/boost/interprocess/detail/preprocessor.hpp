...
//bind rvalues with non-const references, we have to be ugly
   ...
   #if defined(BOOST_MOVE_MSVC_10_RVALUE_REF_BUG)
   ...
   #else //BOOST_MOVE_MSVC_10_RVALUE_REF_BUG
   ...
   #endif //defined(BOOST_MOVE_MSVC_10_RVALUE_REF_BUG)
...
#if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) && defined(BOOST_MOVE_MSVC_10_RVALUE_REF_BUG)

   #define BOOST_INTERPROCESS_PP_FORWARD(z, n, data) BOOST_PP_CAT(this->m_p, n).get() \
   //!

   #define BOOST_INTERPROCESS_PP_IT_FORWARD(z, n, data) \
   BOOST_PP_CAT(*m_p, n).get_lvalue()                          \
   //!

#else

   #define BOOST_INTERPROCESS_PP_FORWARD(z, n, data)       \
...
#endif   //!defined(BOOST_NO_CXX11_RVALUE_REFERENCES) && defined(BOOST_MOVE_MSVC_10_RVALUE_REF_BUG)
