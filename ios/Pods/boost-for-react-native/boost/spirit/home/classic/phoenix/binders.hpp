...
//          3) function_ptr    ( member function pointer binder )
//          4) var_ptr         ( member variable pointer binder )
//
...
//      or
//
//          function_ptr<void, xyz, int> xyz_foo = &xyz::foo;
//
//      The template parameter of the function_ptr is the return,
//      class and argument types of actual signature of the function to
//      be bound read from left to right:
//
//          void xyz::foo_(int); ---> function_ptr<void, xyz, int>
//
//      Take note that a function_ptr lazy-function expects the
...
//      or
//
//          var_ptr<int, xyz> xyz_v = &xyz::v;
//
//      The template parameter of the var_ptr is the type of the
//      variable followed by the class:
//
//          int xyz::v; ---> var_ptr<int, xyz>
//
//      Just like the function_ptr, var_ptr also expects
...
struct var_ptr_action {

    typedef var_ptr_action<T, ClassT> self_t;
    ...
    var_ptr_action(mem_var_ptr_t ptr_)
    :   ptr(ptr_) {}

    template <typename CT>
    typename var_ptr_action_result<self_t, CT>::type
...
template <typename T, typename ClassT>
struct var_ptr
:   public function<var_ptr_action<T, ClassT> > {

    var_ptr(T ClassT::*mp)
    :   function<var_ptr_action<T, ClassT> >
        (var_ptr_action<T, ClassT>(mp)) {}
};

//////////////////////////////////
template <typename T, typename ClassT>
inline var_ptr<T, ClassT>
bind(T ClassT::*mp)
{
    return var_ptr<T, ClassT>(mp);
}
...
>
struct function_ptr
:   public function<function_ptr_action<RT, ClassT
    , A, B, C
#if PHOENIX_LIMIT > 3
    , D, E, F
#if PHOENIX_LIMIT > 6
    ...
    typedef function_ptr_action<RT, ClassT
        , A, B, C
#if PHOENIX_LIMIT > 3
        , D, E, F
#if PHOENIX_LIMIT > 6
...
struct function_ptr_action<RT, ClassT,
    nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 3
    nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
...
> {
    ...
    function_ptr_action(mem_func_ptr_t fptr_)
    :   fptr(fptr_) {}
...
//////////////////////////////////
template <typename RT, typename ClassT>
inline function_ptr<RT, ClassT>
bind(RT(ClassT::*fptr)())
{
    return function_ptr<RT, ClassT>(fptr);
}

template <typename RT, typename ClassT>
inline function_ptr<RT, ClassT const>
bind(RT(ClassT::*fptr)() const)
{
    return function_ptr<RT, ClassT const>(fptr);
}
...
//////////////////////////////////
template <typename RT, typename ClassT, typename A>
inline function_ptr<RT, ClassT, A>
bind(RT(ClassT::*fptr)(A))
{
    return function_ptr<RT, ClassT, A>(fptr);
}

//////////////////////////////////
template <typename RT, typename ClassT, typename A>
inline function_ptr<RT, ClassT const, A>
bind(RT(ClassT::*fptr)(A) const)
{
    return function_ptr<RT, ClassT const, A>(fptr);
}
...
//////////////////////////////////
template <typename RT, typename ClassT, typename A, typename B>
inline function_ptr<RT, ClassT, A, B>
bind(RT(ClassT::*fptr)(A, B))
{
    return function_ptr<RT, ClassT, A, B>(fptr);
}

//////////////////////////////////
template <typename RT, typename ClassT, typename A, typename B>
inline function_ptr<RT, ClassT const, A, B>
bind(RT(ClassT::*fptr)(A, B) const)
{
    return function_ptr<RT, ClassT const, A, B>(fptr);
}
...
//////////////////////////////////
template <typename RT, typename ClassT, typename A, typename B, typename C>
inline function_ptr<RT, ClassT, A, B, C>
bind(RT(ClassT::*fptr)(A, B, C))
{
    return function_ptr<RT, ClassT, A, B, C>(fptr);
}

//////////////////////////////////
template <typename RT, typename ClassT, typename A, typename B, typename C>
inline function_ptr<RT, ClassT const, A, B, C>
bind(RT(ClassT::*fptr)(A, B, C) const)
{
    return function_ptr<RT, ClassT const, A, B, C>(fptr);
}
...
template <typename RT, typename ClassT,
    typename A, typename B, typename C, typename D
>
inline function_ptr<RT, ClassT, A, B, C, D>
...
template <typename RT, typename ClassT,
    typename A, typename B, typename C, typename D
>
inline function_ptr<RT, ClassT const, A, B, C, D>
...
template <typename RT, typename ClassT,
    ...
    typename E
>
inline function_ptr<RT, ClassT, A, B, C, D, E>
...
template <typename RT, typename ClassT,
    ...
    typename E
>
inline function_ptr<RT, ClassT const, A, B, C, D, E>
...
template <typename RT, typename ClassT,
    ...
    typename E, typename F
>
inline function_ptr<RT, ClassT, A, B, C, D, E, F>
...
template <typename RT, typename ClassT,
    ...
    typename E, typename F
>
inline function_ptr<RT, ClassT const, A, B, C, D, E, F>
...
template <typename RT, typename ClassT,
    ...
    typename E, typename F, typename G
>
inline function_ptr<RT, ClassT, A, B, C, D, E, F, G>
...
template <typename RT, typename ClassT,
    ...
    typename E, typename F, typename G
>
inline function_ptr<RT, ClassT const, A, B, C, D, E, F, G>
...
template <typename RT, typename ClassT,
    ...
    typename E, typename F, typename G, typename H
>
inline function_ptr<RT, ClassT, A, B, C, D, E, F, G, H>
...
template <typename RT, typename ClassT,
    ...
    typename E, typename F, typename G, typename H
>
inline function_ptr<RT, ClassT const, A, B, C, D, E, F, G, H>
...
template <typename RT, typename ClassT,
    ...
    typename E, typename F, typename G, typename H, typename I
>
inline function_ptr<RT, ClassT, A, B, C, D, E, F, G, H, I>
...
template <typename RT, typename ClassT,
    ...
    typename E, typename F, typename G, typename H, typename I
>
inline function_ptr<RT, ClassT const, A, B, C, D, E, F, G, H, I>
...
template <typename RT, typename ClassT,
    ...
    typename J
>
inline function_ptr<RT, ClassT, A, B, C, D, E, F, G, H, I, J>
...
template <typename RT, typename ClassT,
    ...
    typename J
>
inline function_ptr<RT, ClassT const, A, B, C, D, E, F, G, H, I, J>
...
template <typename RT, typename ClassT,
    ...
    typename J, typename K
>
inline function_ptr<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K>
...
template <typename RT, typename ClassT,
    ...
    typename J, typename K
>
inline function_ptr<RT, ClassT const, A, B, C, D, E, F, G, H, I, J, K>
...
template <typename RT, typename ClassT,
    ...
    typename J, typename K, typename L
>
inline function_ptr<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L>
...
template <typename RT, typename ClassT,
    ...
    typename J, typename K, typename L
>
inline function_ptr<RT, ClassT const, A, B, C, D, E, F, G, H, I, J, K, L>
...
template <typename RT, typename ClassT,
    ...
    typename J, typename K, typename L, typename M
>
inline function_ptr<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L, M>
...
template <typename RT, typename ClassT,
    ...
    typename J, typename K, typename L, typename M
>
inline function_ptr<RT, ClassT const, A, B, C, D, E, F, G, H, I, J, K, L, M>
...
template <typename RT, typename ClassT,
    ...
    typename J, typename K, typename L, typename M, typename N
>
inline function_ptr<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L, M, N>
...
template <typename RT, typename ClassT,
    ...
    typename J, typename K, typename L, typename M, typename N
>
inline function_ptr<RT, ClassT const, A, B, C, D, E, F, G, H, I, J, K, L, M, N>
...
template <typename RT, typename ClassT,
    ...
    typename O
>
inline function_ptr<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>
...
template <typename RT, typename ClassT,
    ...
    typename O
>
inline function_ptr<RT, ClassT const, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>
...
>
struct bound_member
:   public function<bound_action<RT, ClassT
    , A, B, C
#if PHOENIX_LIMIT > 3
    , D, E, F
#if PHOENIX_LIMIT > 6
    ...
    typedef bound_action<RT, ClassT
        , A, B, C
#if PHOENIX_LIMIT > 3
        , D, E, F
#if PHOENIX_LIMIT > 6
...
> {
    ...
    template <typename CT>
    bound_action(CT & obj_, mem_func_ptr_t fptr_)
