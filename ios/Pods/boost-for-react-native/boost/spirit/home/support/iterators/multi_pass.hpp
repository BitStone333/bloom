...
namespace boost { namespace spirit
{
    ...
    private:
        ...
        typedef boost::base_from_member<shared_data_type*> base;
    ...
    public:
        ...
        multi_pass() : base(static_cast<shared_data_type*>(0)) {}

        explicit multi_pass(T& input)
          : base(new shared_data_type(input)), policies_base_type(input) {}

        explicit multi_pass(T const& input)
          : base(new shared_data_type(input)), policies_base_type(input) {}

        multi_pass(multi_pass const& x)
          : base(x.member), policies_base_type(x)
        {
        ...
        multi_pass(int) : base(static_cast<shared_data_type*>(0)) {}
