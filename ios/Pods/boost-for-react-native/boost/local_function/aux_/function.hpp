...
#define BOOST_LOCAL_FUNCTION_AUX_comma_bind_deref(z, bind_n, unsued) \
    , deref< BOOST_LOCAL_FUNCTION_AUX_bind_type(z, bind_n, ~) >( \
            BOOST_LOCAL_FUNCTION_AUX_bind_member(z, bind_n, ~))

#define BOOST_LOCAL_FUNCTION_AUX_bind_init(z, bind_n, unused) \
    BOOST_LOCAL_FUNCTION_AUX_bind_member(z, bind_n, ~) = addr( \
            BOOST_LOCAL_FUNCTION_AUX_bind_name(z, bind_n, ~));

#define BOOST_LOCAL_FUNCTION_AUX_bind_decl(z, bind_n, unused) \
        ...
        return BOOST_LOCAL_FUNCTION_AUX_call_member(z, defaults_n, ~)( \
            ...
            , \
                BOOST_PP_REPEAT_ ## z \
                    ...
                    BOOST_LOCAL_FUNCTION_AUX_comma_bind_deref, ~) \
...
#undef BOOST_LOCAL_FUNCTION_AUX_comma_bind_deref
#undef BOOST_LOCAL_FUNCTION_AUX_bind_init
#undef BOOST_LOCAL_FUNCTION_AUX_bind_decl
...
#if !BOOST_LOCAL_FUNCTION_CONFIG_LOCALS_AS_TPARAMS
        BOOST_PP_REPEAT(BOOST_LOCAL_FUNCTION_CONFIG_BIND_MAX,
                BOOST_LOCAL_FUNCTION_AUX_bind_init, ~)
#endif
        BOOST_PP_REPEAT(BOOST_PP_INC(BOOST_LOCAL_FUNCTION_AUX_defaults),
...
#if !BOOST_LOCAL_FUNCTION_CONFIG_LOCALS_AS_TPARAMS
    BOOST_PP_REPEAT(BOOST_LOCAL_FUNCTION_CONFIG_BIND_MAX,
            BOOST_LOCAL_FUNCTION_AUX_bind_decl, ~)
#endif
    BOOST_PP_REPEAT(BOOST_PP_INC(BOOST_LOCAL_FUNCTION_AUX_defaults),
