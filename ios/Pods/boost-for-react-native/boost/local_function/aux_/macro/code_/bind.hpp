...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_DECL_VAR_( \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_DECL_( \
        r, id_typename, i, bind_traits) \
    BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_DECL_VAR_(r, \
            BOOST_PP_TUPLE_ELEM(2, 0, id_typename), \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_ALL_( \
    ...
    struct BOOST_SCOPE_EXIT_DETAIL_PARAMS_T(id) { \
        ...
        BOOST_PP_LIST_FOR_EACH_I( \
                ...
                (id, typename01), all_binds) \
        BOOST_PP_LIST_FOR_EACH_I( \
                BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_DECL_, \
                (id, typename01), all_binds) \
