...
struct member:
  mpl::if_c<
    is_const<Type>::value,
    detail::const_base<Class,Type,PtrToMember>,
    detail::non_const_base<Class,Type,PtrToMember>
  >::type
{
};
 ...
 * [non_]const_offset_base is deprecated.
 */

template<class Class,typename Type,std::size_t OffsetOfMember>
struct const_offset_base
{
  typedef Type result_type;
...
struct offset:
  mpl::if_c<
    is_const<Type>::value,
    detail::const_offset_base<Class,Type,OffsetOfMember>,
    detail::non_const_offset_base<Class,Type,OffsetOfMember>
  >::type
{
};

/* BOOST_MULTI_INDEX_MEMBER resolves to member in the normal cases,
 * and to offset as a workaround in those defective compilers for
 * which BOOST_NO_POINTER_TO_TEMPLATE_PARAMETERS is defined.
 */

#if defined(BOOST_NO_POINTER_TO_TEMPLATE_PARAMETERS)
#define BOOST_MULTI_INDEX_MEMBER(Class,Type,MemberName) \
::boost::multi_index::offset< Class,Type,offsetof(Class,MemberName) >
#else
#define BOOST_MULTI_INDEX_MEMBER(Class,Type,MemberName) \
