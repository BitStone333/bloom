...
#define TYPE_OF(TYPE)                                             \
    template <typename C>                                                       \
    struct BOOST_PP_CAT(TYPE, _of)                                       \
    {                                                                           \
        typedef typename C::TYPE type;                                   \
    }

    TYPE_OF(allocator_type);
    TYPE_OF(const_iterator);
    TYPE_OF(const_reference);
    TYPE_OF(const_reverse_iterator);
    TYPE_OF(container_type);
    TYPE_OF(data_type);
    TYPE_OF(iterator);
    TYPE_OF(key_compare);
    TYPE_OF(key_type);
    TYPE_OF(reference);
    TYPE_OF(reverse_iterator);
    TYPE_OF(size_type);
    TYPE_OF(value_compare);
    TYPE_OF(value_type);
