...
namespace boost { namespace phoenix
{
    ...
    typename detail::expression::function_eval<
            detail::function_ptr<0, RT, RT(ClassT::*)()>
          , ClassA >
    >::type const
    bind(RT(ClassT::*f)(), ClassA const& obj)
    {
        typedef detail::function_ptr<0, RT, RT(ClassT::*)()> fp_type;
        return
    ...
    typename boost::lazy_enable_if<
      boost::is_function_pointer<RT (ClassT::*)()>,
    typename detail::expression::function_eval<
            detail::function_ptr<0, RT, RT(ClassT::*)() const>
          , ClassA >
    >::type const
    ...
    {
        typedef detail::function_ptr<0, RT, RT(ClassT::*)() const> fp_type;
        return
            detail::expression::function_eval<
                fp_type
              , ClassT
