...
namespace boost { namespace phoenix { namespace detail
{
    ...
    struct function_ptr
        : function_ptr_impl<N>::template impl<RT, FP>
    {
        typedef typename function_ptr_impl<N>::
        ...
        bool operator==(function_ptr<M, RhsRT, RhsFP> const &) const
        {
            return false;
        }
    };
...
///////////////////////////////////////////////////////////////////////////////
    ...
    template <>
    struct function_ptr_impl<BOOST_PHOENIX_ITERATION>
    {
        template <typename RT, typename FP>
        struct impl
        {
