...
==============================================================================*/
#ifndef BOOST_PHOENIX_CORE_DETAIL_VARIABLE_HPP
#define BOOST_PHOENIX_CORE_DETAIL_VARIABLE_HPP
...
namespace boost { namespace phoenix { namespace detail {
        ...
        struct variable
        {
            ...
            RT& operator()(Class& obj) const
            {
                ...
                typedef typename proto::detail::class_traits<MP>::class_type class_type;
