...
# define BOOST_PARAMETER_FUNCTION_CHECK_STATIC_static ()
# define BOOST_PARAMETER_FUNCTION_IS_STATIC(name) \
    BOOST_PARAMETER_IS_NULLARY( \
        BOOST_PP_CAT(BOOST_PARAMETER_FUNCTION_CHECK_STATIC_,name) \
    )

# if !defined(BOOST_MSVC)
#  define BOOST_PARAMETER_FUNCTION_STRIP_STATIC_static
#  define BOOST_PARAMETER_FUNCTION_STRIP_STATIC(name) \
    BOOST_PP_CAT(BOOST_PARAMETER_FUNCTION_STRIP_STATIC_, name)
# else
...
#  define BOOST_PARAMETER_FUNCTION_STRIP_STATIC_static (
#  define BOOST_PARAMETER_FUNCTION_STRIP_STATIC_AUX(name) \
    BOOST_PP_CAT(BOOST_PARAMETER_FUNCTION_STRIP_STATIC_, name))
#  define BOOST_PARAMETER_FUNCTION_STRIP_STATIC(name) \
    BOOST_PP_SEQ_HEAD( \
        BOOST_PARAMETER_FUNCTION_STRIP_STATIC_AUX(name) \
    )
# endif

# define BOOST_PARAMETER_FUNCTION_STATIC(name) \
    BOOST_PP_EXPR_IF( \
        BOOST_PARAMETER_FUNCTION_IS_STATIC(name) \
      , static \
    )

# define BOOST_PARAMETER_FUNCTION_NAME(name) \
    BOOST_PP_IF( \
        BOOST_PARAMETER_FUNCTION_IS_STATIC(name) \
      , BOOST_PARAMETER_FUNCTION_STRIP_STATIC \
...
# define BOOST_PARAMETER_FUNCTION_PARAMETERS_NAME(base) \
    BOOST_PP_CAT( \
      ...
      , BOOST_PP_CAT(__LINE__, BOOST_PARAMETER_FUNCTION_NAME(base)) \
    )
...
# define BOOST_PARAMETER_IMPL(base) \
    BOOST_PP_CAT(boost_param_impl,BOOST_PARAMETER_FUNCTION_NAME(base))
...
# define BOOST_PARAMETER_FUNCTION_FWD_FUNCTION00(z, n, r, data, elem) \
    ...
    BOOST_PARAMETER_FUNCTION_STATIC(BOOST_PP_TUPLE_ELEM(7,3,data)) \
    inline \
    BOOST_PP_EXPR_IF(n, typename) \
        ...
        >::type \
    >::type \
    BOOST_PARAMETER_FUNCTION_NAME(BOOST_PP_TUPLE_ELEM(7,3,data))( \
        BOOST_PP_IF( \
            n \
...
# define BOOST_PARAMETER_FUNCTION_PARAMETERS(tag_namespace, base, args)             \
    ...
    struct BOOST_PP_CAT(                                                            \
          ...
          , BOOST_PARAMETER_FUNCTION_NAME(base)                              \
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(name) \
    BOOST_PP_CAT( \
      ...
      , BOOST_PP_CAT(__LINE__, BOOST_PARAMETER_FUNCTION_NAME(name)) \
    )
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT_BODY(name, n, split_args, tag_ns, const_) \
    ...
    > \
    BOOST_PARAMETER_FUNCTION_STATIC(name) \
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_FUNCTION0(z, n, data) \
    ...
    > \
    BOOST_PARAMETER_FUNCTION_STATIC(BOOST_PP_TUPLE_ELEM(5,0,data)) \
...
# define BOOST_PARAMETER_BASIC_FUNCTION_AUX(result, name, tag_namespace, args, const_) \
    BOOST_PARAMETER_FUNCTION_HEAD(result, name, tag_namespace, args)                    \
                                                                                        \
    BOOST_PARAMETER_FUNCTION_FWD_FUNCTIONS(                                             \
...
# define BOOST_PARAMETER_BASIC_CONST_FUNCTION(result, name, tag_namespace, args) \
    BOOST_PARAMETER_BASIC_FUNCTION_AUX( \
        result, name, tag_namespace \
      , BOOST_PARAMETER_FLATTEN(2, 2, 3, args) \
      , 1 \
...
# define BOOST_PARAMETER_FUNCTION_AUX(result, name, tag_namespace, const_, args)    \
    BOOST_PARAMETER_FUNCTION_HEAD(result, name, tag_namespace, args)         \
\
    BOOST_PARAMETER_FUNCTION_FWD_FUNCTIONS(                                  \
        result, name, args, const_                                           \
...
# define BOOST_PARAMETER_CONST_FUNCTION(result, name, tag_namespace, args)    \
    BOOST_PARAMETER_FUNCTION_AUX(                                       \
