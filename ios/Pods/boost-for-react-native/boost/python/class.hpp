...
# include <boost/type_traits/is_function_pointer.hpp>
...
#  define BOOST_PYTHON_NO_POINTER_ORDERING 1

# endif

# ifdef BOOST_PYTHON_NO_POINTER_ORDERING
...
namespace detail
{
  ...
  struct is_data_pointer
      : mpl::and_<
            is_pointer<T>
          , mpl::not_<is_function_pointer<T> >
        >
  {};
  
# ifdef BOOST_PYTHON_NO_POINTER_ORDERING
#  define BOOST_PYTHON_DATA_HELPER(D) , detail::is_data_pointer<D>()
...
# endif 
            typedef typename assertion<is_function_pointer<Fn> >::failed test2 BOOST_ATTRIBUTE_UNUSED;
...
class class_ : public objects::class_base
{
 ...
 public: // member functions
    ...
    {
        return this->def_readonly_impl(name, d, doc BOOST_PYTHON_DATA_HELPER(D));
    }

    template <class D>
    self& def_readwrite(char const* name, D const& d, char const* doc=0)
    {
        return this->def_readwrite_impl(name, d, doc BOOST_PYTHON_DATA_HELPER(D));
    }
 ...
 private: // helper functions
    ...
    object make_getter(F f)
    {
        ...
        return this->make_fn_impl(
            detail::unwrap_wrapper((W*)0)
          , f, is_obj_or_proxy(), (char*)0, detail::is_data_pointer<F>()
        );
    }
    ...
    object make_setter(F f)
    {
        ...
        return this->make_fn_impl(
            detail::unwrap_wrapper((W*)0)
          , f, is_obj_or_proxy(), (int*)0, detail::is_data_pointer<F>()
        );
    }
...
# undef BOOST_PYTHON_DATA_HELPER
# undef BOOST_PYTHON_YES_DATA_MEMBER
# undef BOOST_PYTHON_NO_DATA_MEMBER
# undef BOOST_PYTHON_NO_POINTER_ORDERING
