...
#define    BOOST_QUATERNION_ASSIGNMENT_GENERATOR(type)                               \
            template<typename X>                                                            \
...
#define    BOOST_QUATERNION_DATA_GENERATOR(type)       \
            type    a;                                        \
            type    b;                                        \
            type    c;                                        \
            type    d;
        ...
        public:
            ...
            BOOST_QUATERNION_ASSIGNMENT_GENERATOR(T)
        ...
        protected:
            ...
            BOOST_QUATERNION_DATA_GENERATOR(T)
...
#define    BOOST_QUATERNION_ADD_GENERATOR_1(type)             \
...
#define    BOOST_QUATERNION_ADD_GENERATOR_2(type)                             \
...
#define    BOOST_QUATERNION_ADD_GENERATOR_3(type)                      \
            template<typename X>                                              \
...
#define    BOOST_QUATERNION_SUB_GENERATOR_1(type)             \
            quaternion<type> &        operator -= (type const & rhs) \
            {                                                        \
                a -= rhs;                                            \
                                                                     \
...
#define    BOOST_QUATERNION_SUB_GENERATOR_2(type)                             \
            quaternion<type> &        operator -= (::std::complex<type> const & rhs) \
            {                                                                        \
                a -= rhs.real();                                                     \
                b -= rhs.imag();                                                     \
...
#define    BOOST_QUATERNION_SUB_GENERATOR_3(type)                      \
            template<typename X>                                              \
            quaternion<type> &        operator -= (quaternion<X> const & rhs) \
            {                                                                 \
                a -= static_cast<type>(rhs.R_component_1());                  \
...
#define    BOOST_QUATERNION_MUL_GENERATOR_1(type)             \
            quaternion<type> &        operator *= (type const & rhs) \
            {                                                        \
                a *= rhs;                                            \
                b *= rhs;                                            \
...
#define    BOOST_QUATERNION_MUL_GENERATOR_2(type)                             \
            quaternion<type> &        operator *= (::std::complex<type> const & rhs) \
            {                                                                        \
                type    ar = rhs.real();                                             \
                type    br = rhs.imag();                                             \
...
#define    BOOST_QUATERNION_MUL_GENERATOR_3(type)                      \
            template<typename X>                                              \
            quaternion<type> &        operator *= (quaternion<X> const & rhs) \
            {                                                                 \
...
#define    BOOST_QUATERNION_DIV_GENERATOR_1(type)             \
            quaternion<type> &        operator /= (type const & rhs) \
            {                                                        \
                a /= rhs;                                            \
                b /= rhs;                                            \
    ...
    #define    BOOST_QUATERNION_DIV_GENERATOR_2(type)                         \
            quaternion<type> &        operator /= (::std::complex<type> const & rhs) \
            {                                                                        \
                using    ::std::valarray;                                            \
                using    ::std::abs;                                                 \
...
#if defined(BOOST_NO_ARGUMENT_DEPENDENT_LOOKUP)
    #define    BOOST_QUATERNION_DIV_GENERATOR_3(type)                  \
            template<typename X>                                              \
            quaternion<type> &        operator /= (quaternion<X> const & rhs) \
            {                                                                 \
                using    ::std::valarray;                                     \
...
#define    BOOST_QUATERNION_ADD_GENERATOR(type)   \
        BOOST_QUATERNION_ADD_GENERATOR_1(type)    \
        BOOST_QUATERNION_ADD_GENERATOR_2(type)    \
        BOOST_QUATERNION_ADD_GENERATOR_3(type)
        
#define    BOOST_QUATERNION_SUB_GENERATOR(type)   \
        BOOST_QUATERNION_SUB_GENERATOR_1(type)    \
        BOOST_QUATERNION_SUB_GENERATOR_2(type)    \
        BOOST_QUATERNION_SUB_GENERATOR_3(type)
        
#define    BOOST_QUATERNION_MUL_GENERATOR(type)   \
        BOOST_QUATERNION_MUL_GENERATOR_1(type)    \
        BOOST_QUATERNION_MUL_GENERATOR_2(type)    \
        BOOST_QUATERNION_MUL_GENERATOR_3(type)
        
#define    BOOST_QUATERNION_DIV_GENERATOR(type)   \
        BOOST_QUATERNION_DIV_GENERATOR_1(type)    \
        BOOST_QUATERNION_DIV_GENERATOR_2(type)    \
        BOOST_QUATERNION_DIV_GENERATOR_3(type)
        
#define    BOOST_QUATERNION_ALGEBRAIC_GENERATOR(type)   \
        BOOST_QUATERNION_ADD_GENERATOR(type)            \
        BOOST_QUATERNION_SUB_GENERATOR(type)            \
        BOOST_QUATERNION_MUL_GENERATOR(type)            \
        BOOST_QUATERNION_DIV_GENERATOR(type)
        ...
        public:
            ...
            BOOST_QUATERNION_ASSIGNMENT_GENERATOR(float)
            ...
            BOOST_QUATERNION_ALGEBRAIC_GENERATOR(float)
            
            
        protected:
            
            BOOST_QUATERNION_DATA_GENERATOR(float)
        ...
        public:
            ...
            BOOST_QUATERNION_ASSIGNMENT_GENERATOR(double)
            ...
            BOOST_QUATERNION_ALGEBRAIC_GENERATOR(double)
            
            
        protected:
            
            BOOST_QUATERNION_DATA_GENERATOR(double)
        ...
        public:
            ...
            BOOST_QUATERNION_ASSIGNMENT_GENERATOR(long double)
            ...
            BOOST_QUATERNION_ALGEBRAIC_GENERATOR(long double)
            
            
        protected:
            
            BOOST_QUATERNION_DATA_GENERATOR(long double)
...
#undef    BOOST_QUATERNION_ALGEBRAIC_GENERATOR
#undef    BOOST_QUATERNION_ADD_GENERATOR
#undef    BOOST_QUATERNION_SUB_GENERATOR
#undef    BOOST_QUATERNION_MUL_GENERATOR
#undef    BOOST_QUATERNION_DIV_GENERATOR
#undef    BOOST_QUATERNION_ADD_GENERATOR_1
#undef    BOOST_QUATERNION_ADD_GENERATOR_2
#undef    BOOST_QUATERNION_ADD_GENERATOR_3
#undef    BOOST_QUATERNION_SUB_GENERATOR_1
#undef    BOOST_QUATERNION_SUB_GENERATOR_2
#undef    BOOST_QUATERNION_SUB_GENERATOR_3
#undef    BOOST_QUATERNION_MUL_GENERATOR_1
#undef    BOOST_QUATERNION_MUL_GENERATOR_2
#undef    BOOST_QUATERNION_MUL_GENERATOR_3
#undef    BOOST_QUATERNION_DIV_GENERATOR_1
#undef    BOOST_QUATERNION_DIV_GENERATOR_2
#undef    BOOST_QUATERNION_DIV_GENERATOR_3
        
#undef    BOOST_QUATERNION_CONSTRUCTOR_GENERATOR
        
        
#undef    BOOST_QUATERNION_ASSIGNMENT_GENERATOR
        
#undef    BOOST_QUATERNION_DATA_GENERATOR
