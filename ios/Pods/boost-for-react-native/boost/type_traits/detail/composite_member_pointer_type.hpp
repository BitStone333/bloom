...
template<class C, class T> struct composite_pointer_type<T C::*, decltype(nullptr)>
{
    typedef T C::* type;
};

template<class C, class T> struct composite_pointer_type<decltype(nullptr), T C::*>
{
    typedef T C::* type;
};
...
template<class C, class T> struct composite_pointer_type<T C::*, std::nullptr_t>
{
    typedef T C::* type;
};

template<class C, class T> struct composite_pointer_type<std::nullptr_t, T C::*>
{
    typedef T C::* type;
};
...
template<class C1, class C2> struct common_class;

template<class C> struct common_class<C, C>
{
    typedef C type;
};
...
struct common_class_pointer_to_member
{
    typedef CT CB::* type;
};

template<class C1, class T1, class C2, class T2> struct composite_pointer_type<T1 C1::*, T2 C2::*>
{
private:
    ...
    typedef typename common_class<C1, C2>::type CB;

public:

    typedef typename common_class_pointer_to_member<CT, CB>::type type;
};
