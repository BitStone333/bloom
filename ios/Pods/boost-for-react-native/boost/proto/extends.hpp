...
namespace boost { namespace proto
{
    ...
    namespace exprns_
    {
        ...
        struct virtual_member
        {
            ...
            {
                using std::size_t;
                return *(This *)((char *)this - BOOST_PROTO_OFFSETOF(This, proto_union_start_));
            }
        ...
        /// INTERNAL ONLY
        ///
        #define BOOST_PROTO_EXTENDS_(R, DOMAIN, ELEM)                                            \
        ...
        #define BOOST_PROTO_EXTENDS_MEMBERS_WITH_DOMAIN(SEQ, DOMAIN)                                    \
            union                                                                                       \
            {                                                                                           \
                char proto_union_start_;                                                         \
                BOOST_PP_SEQ_FOR_EACH(BOOST_PROTO_EXTENDS_, DOMAIN, SEQ)                         \
            };                                                                                          \
            /**/
