...
#include <boost/type_traits/is_object_pointer.hpp>
...
namespace boost { namespace proto
{
    namespace detail
    {
        ...
        #include <boost/proto/detail/class_traits.hpp>
        ...
        namespace get_pointerns
        {
            ...
            struct result_of_<T U::*(V), typename enable_if_c<is_object_pointer<T U::*>::value>::type>
            {
            ...
            template<
                typename T
              , typename U
              , bool IsMemPtr = is_object_pointer<
        ...
        struct memfun
        {
            ...
            typedef typename class_traits<pmf_type>::class_type V;
            typedef typename class_traits<pmf_type>::result_type result_type;
