...
namespace member {
FOLLY_CREATE_INVOKER(lock_invoker, lock);
FOLLY_CREATE_INVOKER(try_lock_for_invoker, try_lock_for);
FOLLY_CREATE_INVOKER(lock_shared_invoker, lock_shared);
FOLLY_CREATE_INVOKER(lock_upgrade_invoker, lock_upgrade);
} // namespace member
