 ...
 */
using IntrusiveListHook = boost::intrusive::list_hook<
...
using IntrusiveList = boost::intrusive::list<
    T,
    boost::intrusive::hook<T, IntrusiveListHook, PtrToMember>,
    boost::intrusive::constant_time_size<false>>;

/**
 * A safe-link intrusive list hook.
 */
using SafeIntrusiveListHook = boost::intrusive::list_hook<
...
using CountedIntrusiveList = boost::intrusive::list<
    T,
    boost::intrusive::hook<T, SafeIntrusiveListHook, PtrToMember>,
