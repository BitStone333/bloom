...
#define FOLLY_CREATE_HAS_TYPE_TRAITS(classname, type_name)              \
...
#define FOLLY_CREATE_HAS_FN_TRAITS_IMPL(classname, func_name, cv_qual) \
...
/*
 * The FOLLY_CREATE_HAS_FN_TRAITS is used to create traits
 ...
 * namespace {
 *
 * FOLLY_CREATE_HAS_FN_TRAITS(has_test_traits, test);
 *
 * } // unnamed-namespace
 *
 * void some_func() {
 ...
 */
#define FOLLY_CREATE_HAS_FN_TRAITS(classname, func_name)               \
  template <typename, typename>                                               \
  struct classname##__folly_traits_impl__;                                    \
  FOLLY_CREATE_HAS_FN_TRAITS_IMPL(classname, func_name, );             \
  FOLLY_CREATE_HAS_FN_TRAITS_IMPL(classname, func_name, const);        \
  FOLLY_CREATE_HAS_FN_TRAITS_IMPL(                                     \
...
#define FOLLY_HAS_TRUE_XXX(name)                                             \
  FOLLY_CREATE_HAS_TYPE_TRAITS(has_##name, name);                     \
  template <class T>                                                         \
