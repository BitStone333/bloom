 ...
 *    traits::is_nothrow_invocable_v<char*, CanFoo, Car&&> // false
 */
#define FOLLY_CREATE_INVOKER(classname, membername)                 \
  struct classname {                                                       \
 ...
 *  Example:
 *
 *    FOLLY_CREATE_STATIC_INVOKER(foo_invoker, foo);
 *
 ...
 */
#define FOLLY_CREATE_STATIC_INVOKER(classname, membername)       \
  template <typename T>                                                 \
  struct classname {                                                    \
    template <typename... Args>                                         \
